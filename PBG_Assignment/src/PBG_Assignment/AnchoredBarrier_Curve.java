...
public class AnchoredBarrier_Curve extends AnchoredBarrier {
    ...
    public Vec2 centreOfCircleBarrierArc;
    ...
    public AnchoredBarrier_Curve(float centrex, float centrey, float radiusOfBarrier, float startAngle, float deltaAngle, Color col) {
        ...
        this.radiusInScreenCoordinates = (int) Main.convertWorldLengthToScreenLength(radiusOfBarrier);
        this.col = col;
    ...
    public void draw(Graphics2D g) {
        int x1 = Main.convertWorldXtoScreenX(centreOfCircleBarrierArc.x);
        int y1 = Main.convertWorldYtoScreenY(centreOfCircleBarrierArc.y);
