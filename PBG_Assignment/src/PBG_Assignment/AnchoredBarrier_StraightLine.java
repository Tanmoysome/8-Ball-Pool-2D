...
public class AnchoredBarrier_StraightLine extends AnchoredBarrier {
    ...
    public void draw(Graphics2D g) {
        int x1 = Main.convertWorldXtoScreenX(startPos.x);
        int y1 = Main.convertWorldYtoScreenY(startPos.y);
        int x2 = Main.convertWorldXtoScreenX(endPos.x);
        int y2 = Main.convertWorldYtoScreenY(endPos.y);
        g.setColor(col);
