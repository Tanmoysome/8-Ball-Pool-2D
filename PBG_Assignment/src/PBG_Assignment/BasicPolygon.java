...
//		body.createFixture(fixtureDef2);
        ...
        this.mass = mass;
        this.ratioOfScreenScaleToWorldScale = Main.convertWorldLengthToScreenLength(1);
    ...
    public void draw(Graphics2D g) {
        ...
        af.translate(Main.convertWorldXtoScreenX(position.x), Main.convertWorldYtoScreenY(position.y));
        af.scale(ratioOfScreenScaleToWorldScale, -ratioOfScreenScaleToWorldScale - 2000);// there is a minus in here because screenworld is flipped upsidedown compared to physics world
        af.rotate(angle);
